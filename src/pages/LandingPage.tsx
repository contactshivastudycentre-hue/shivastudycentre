            ...
            <div className="bg-card rounded-2xl p-8 md:p-10 border border-border">
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  {/* CTA */}
                  <a href="https://kairaux.online" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl font-medium hover:bg-primary/90 transition-colors">
